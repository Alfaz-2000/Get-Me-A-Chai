  ...
  return (
    <>
      <div className="flex justify-center flex-col gap-4 items-center text-white h-[44vh] px-5 md:px-0 text-xs md:text-base ">
        <div className="font-bold flex gap-2 md:gap-20 text-xl md:text-5xl  justify-center items-center"><span>GetMeAChai!</span> <img className="invertImg" src="/tea.gif" width={88} alt="tea-image" /> </div>
        <p className="text-center md:text-left">A funding platform for developers, get funded by pepole</p>
        <p className="text-center md:text-left">a place where your fans can support you by buying you chai</p>
        <div className="">
          <Link href="/login">
      ...
      <div className="text-white container mx-auto pb-32 pt-14 px-10">
        ...
        <div className="flex gap-5 justify-around">
          <div className="item space-y-3 flex flex-col justify-center items-center">
            ...
            <p className="font-bold text-center">fans can fund you</p>
        ...
        <div className="text-white container mx-auto pb-32 pt-14 flex flex-col items-center justify-center">
          ...
          <div className="w-[90%] h-[40vh] md:w[50%] md:h-[40vh] lg:w-[50%] lg:h-[40vh] xl:w-[50%] xl:h-[40vh] 2xl:w-[50%] 2xl:h-[40vh]">
